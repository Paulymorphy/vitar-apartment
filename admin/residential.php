...
<div id="myModalDelete" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header" style = "background-color: #18D0FF">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Delete Residential Space</h4>
      </div>
      <div class="modal-body">
      <form>
            ...
            <div class = "form-group">
                ...
                <input type="textarea" placeholder="Description" class="form-control" id="DeleteDesc" name ="txtDescription" required>
            </div>
            <div class = "form-group">
                <label> Rate: </label>
                <input type="Number" placeholder="Price Rate" class="form-control" id="DeleteName" name ="txtRate" required>
            </div>
      </form>
      </div>
      <div class="modal-footer">
