...
CREATE DEFINER=`root`@`localhost` PROCEDURE `addRentable` (IN `_rate` INT(7) UNSIGNED, IN `_type` VARCHAR(30), IN `_desc` VARCHAR(500))  MODIFIES SQL DATA
INSERT INTO rentable(monthlyRate, type, detailDesc) VALUES (_rate, _type, _desc)$$
